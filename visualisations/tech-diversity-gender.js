function TechDiversityGender() {
  ...
  this.draw = function() {
    ...
    // var sorting=this.sortby.value();
    // var direction=this.sortdirection.value();
    ...
    this.stackedbar = new StackedBar(this.data,title,refpoint,AColour,BColour,classes);

    this.stackedbar.draw();
